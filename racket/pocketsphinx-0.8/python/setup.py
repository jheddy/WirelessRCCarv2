...
# If there is no /home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8 and friends use pkg-config
if '/home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8' == '' or '/home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8/include',
                   '/home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8/include']
    sb_libdirs = ['/home/jheddy/pocketsphinx-0.8/../sphinxbase-0.8/src/libsphinxbase/.libs']
